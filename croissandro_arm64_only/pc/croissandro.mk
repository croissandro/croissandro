...
#
$(call inherit-product, device/croissandro/shared/pc/device_vendor.mk)

#
# Special settings for the target
#
$(call inherit-product, device/croissandro/croissandro_arm64_only/bootloader.mk)

PRODUCT_NAME := croissandro_arm64_only_pc
PRODUCT_DEVICE := croissandro_arm64_only
PRODUCT_MANUFACTURER := CroissAndro
PRODUCT_MODEL := CroissAndro ARM64 PC (64-bit only)
