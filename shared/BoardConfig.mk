...
ifneq (,$(findstring _desktop,$(PRODUCT_NAME)))
...
SYSTEM_DLKM_SRC ?= device/croissandro_prebuilts/kernel/6.6-$(TARGET_KERNEL_ARCH)-desktop/system_dlkm
KERNEL_MODULES_PATH ?= device/croissandro_prebuilts/kernel/6.6-$(TARGET_KERNEL_ARCH)-desktop/vendor_dlkm
else
...
ifneq (,$(findstring auto, $(PRODUCT_NAME)))
# Support Arm64 CroissAndro on-device deployment
...
BOARD_VENDOR_KERNEL_MODULES_BLOCKLIST_FILE := \
    device/croissandro/shared/modules_aarch64.blocklist
else
BOARD_VENDOR_KERNEL_MODULES_BLOCKLIST_FILE := \
    device/croissandro/shared/modules.blocklist
endif

BOARD_VENDOR_RAMDISK_KERNEL_MODULES_OPTIONS_FILE := \
    device/croissandro/shared/config/first_stage_modules.options
...
# TODO: Change this to a real key once CroissAndro has a signing key
...
# vendor sepolicy
BOARD_VENDOR_SEPOLICY_DIRS += device/croissandro/shared/sepolicy/vendor
BOARD_VENDOR_SEPOLICY_DIRS += device/croissandro/shared/sepolicy/vendor/seriallogging
BOARD_VENDOR_SEPOLICY_DIRS += device/croissandro/shared/sepolicy/vendor/croissandro

BOARD_SEPOLICY_DIRS += system/bt/vendor_libs/linux/sepolicy

# product sepolicy, allow other layers to append
PRODUCT_PRIVATE_SEPOLICY_DIRS += device/croissandro/shared/sepolicy/product/private
# PRODUCT_PUBLIC_SEPOLICY_DIRS += device/croissandro/shared/sepolicy/product/public
# system_ext sepolicy
SYSTEM_EXT_PRIVATE_SEPOLICY_DIRS += device/croissandro/shared/sepolicy/system_ext/private
# SYSTEM_EXT_PUBLIC_SEPOLICY_DIRS += device/croissandro/shared/sepolicy/system_ext/public
...
# CroissAndro doesn't use CMA, so don't reserve RAM for it
...
PRODUCT_COPY_FILES += \
    device/croissandro/dtb.img:dtb.img \
    device/croissandro/required_images:required_images \
...
# Enable the new fingerprint format on croissandro
